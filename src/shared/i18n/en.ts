...
export const en = {
  ...
  relation: {
    ...
    goalTitle: 'Goal', goalDescription: 'What does success look like?', taskTitle: 'Task', taskInstructions: 'Instructions',
    dueDate: 'Due date', dueDateHint: 'YYYY-MM-DD, optional', dueInvalid: 'Use the format YYYY-MM-DD, today or later.', dueIn: { d1: 'Tomorrow', d3: 'In 3 days', d7: 'In a week', none: 'No due date' },
    overdue: 'Overdue', editTask: 'Edit', dropTask: 'Drop', dropTaskConfirm: 'Drop this task? It stays in the history but no longer counts as open.',
    dropGoal: 'Drop', dropGoalConfirm: 'Drop this goal? Focus moves to the next active goal.',
    requestCompletion: 'Ask teacher to confirm', completionRequested: 'Waiting for confirmation', confirmCompletion: 'Confirm achieved', declineCompletion: 'Not yet',
    declineNote: 'What is still missing? (optional, sent in chat)',
    allEvidence: 'All', evidenceStatus: { submitted: 'Awaiting review', reviewed: 'Reviewed', needs_revision: 'Needs revision', revised: 'Revised, awaiting review' },
    outcome: { approved: 'Approve', needs_revision: 'Ask for revision' }, outcomeTag: { approved: 'Approved', needs_revision: 'Revision requested' },
    revise: 'Revise and resubmit', reviseHint: 'Your teacher asked for changes. Update your work and resubmit; the previous version is kept.',
    history: 'Earlier versions', versionN: 'Version {n}', attachmentsN: '{n} attachments',
  ...
  qa: {
    ...
    inboxBody: 'Unanswered questions in topics that match the subjects on your profile.', inboxNoTopics: 'Add subjects to your teacher profile that match a topic (for example Math or Programming) to see questions here.',
    ...
    followUp: 'Ask a follow-up', followUpHint: 'You can ask each teacher one follow-up.', followUpBy: 'Follow-up from the asker', sendFollowUp: 'Send follow-up',
    closeQuestion: 'Close question', closeConfirm: 'Close this question? No one will be able to answer it after that.', closesOn: 'Closes {date}',
    closedNote: 'This question is closed.', editQuestion: 'Edit question', saveQuestion: 'Save changes', editLocked: 'Questions can only be edited before anyone answers.',
    workWith: 'Ask this teacher to work with you', teacherBadge: 'Teacher', reportPost: 'Report', reported: 'Thanks. A moderator will review this.',
    studentsOnly: 'Asking questions needs the student role. You can add it in Settings.', teacherOnly: 'Only teachers answer questions here.',
    acceptedAnswers: 'Answers that helped learners', ago: 'Asked {when}', by: 'by {name}', more: 'Load more', browse: 'Browse questions', hub: 'Questions by topic',
    askCta: 'Stuck on something specific? Ask teachers in a topic.',
  },
  contacts: {
