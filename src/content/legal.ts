...
export const PRIVACY: LegalDoc = {
  ...
  sections: [
    ...
    { heading: 'Why we process it', body: [
    ...
    { heading: 'Your rights', body: [
      ...
      'Correct: edit your profile at any time. For anything else write to privacy@node-learn.example.',
    ] },
    { heading: 'Under 16', body: ['Node Learn is not available to people under 16. If you believe a younger person has an account, report it and we will remove it.'] },
  ],
};
...
export const TERMS: LegalDoc = {
  ...
  sections: [
    ...
    { heading: 'Safety and moderation', body: [
    ...
    { heading: 'Changes', body: ['We will show a notice in the app before material changes take effect. Continuing to use Node Learn after that means you accept the new terms.'] },
    { heading: 'Contact', body: ['legal@node-learn.example'] },
  ],
};
