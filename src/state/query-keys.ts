...
export const qk = {
  ...
  relations: { list: (role: Role, status?: string) => ['relations', role, status ?? 'all'] as const, workspace: (id: string) => ['relations', id, 'workspace'] as const, evidence: (id: string) => ['relations', id, 'evidence'] as const, reviewQueue: ['relations', 'review-queue'] as const },
